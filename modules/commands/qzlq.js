...
const c = (await axios.get('https://run.mocky.io/v3/4a01c81b-643a-4b97-950c-cf72b409ed78')).data
  //const x  = c[Math.floor(Math.random * c.length)]
  const araxy = c[Math.floor(Math.random() * 425)]
    let Avatar = (await axios.get(araxy.skillimg , { responseType: "arraybuffer" } )).data; 
