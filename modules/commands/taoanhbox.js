...
module.exports.circle = async (image) => {
  ...
  if(!fs.existsSync(__dirname+`/cache/TUVBenchmark.ttf`)) { 
      let downFonts = (await axios.get(`https://drive.google.com/u/0/uc?id=1jv4ludBd7hWuEiOs13kR0JXljCxkOYUl&export=download`, { responseType: "arraybuffer" })).data;
  ...
  /*=================DRAW AVATAR MEMBERS==============*/
    for(let idUser of live) {
      ...
      try { var avtUser = await superfetch.get(`https://graph.facebook.com/${idUser.id}/picture?width=512&height=512&access_token=6628568379%7Cc1e620fa708a1d5696fb991c1bde5662`) } 
      catch(e) { continue }
