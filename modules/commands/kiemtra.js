...
module.exports.run = async ({ args, api, event, Currencies, client }) => {
   ...
   if (args.length == 0) return api.sendMessage(`     ===  𝐃𝐚𝐧𝐡 𝐒𝐚́𝐜𝐡 𝐤𝐢𝐞𝐦𝐭𝐫𝐚  === \n----------------\n[💌] => 𝐤𝐢𝐞𝐦𝐭𝐫𝐚 𝗻𝗱𝗳𝗯 => 𝗟𝗼̣𝗰 𝘁𝗵𝗮̀𝗻𝗵 𝘃𝗶𝗲̂𝗻 𝗯𝗶̣ 𝗯𝗮𝘆 𝗮𝗰𝗰 𝗸𝗵𝗼̉𝗶 𝗻𝗵𝗼́𝗺\n----------------\n[💌] => 𝐤𝐢𝐞𝐦𝐭𝐫𝐚 𝗱𝗲𝗹 => 𝗟𝗼̣𝗰 𝘁𝗵𝗮̀𝗻𝗵 𝘃𝗶𝗲̂𝗻 𝗸𝗵𝗼̉𝗶 𝗻𝗵𝗼́𝗺 𝘁𝗵𝗲𝗼 𝘀𝗼̂́ 𝘁𝗶𝗻 𝗻𝗵𝗮̆́𝗻\n----------------\n[💌] => 𝐤𝐢𝐞𝐦𝐭𝐫𝐚 𝗼𝗻𝗹 => 𝗫𝗲𝗺 𝘁𝗵𝗼̛̀𝗶 𝗴𝗶𝗮𝗻 𝗯𝗼𝘁 𝗰𝗵𝗮̣𝘆\n----------------\n[💌] => 𝐤𝐢𝐞𝐦𝐭𝐫𝐚 𝘁𝘁 => 𝐤𝐢𝐞𝐦𝐭𝐫𝐚 𝘁𝗶̉ 𝗹𝗲̣̂ 𝘁𝘂̛𝗼̛𝗻𝗴 𝘁𝗮́𝗰 𝗰𝘂̉𝗮 𝗯𝗮̣𝗻\n----------------\n[💌] => 𝐤𝐢𝐞𝐦𝐭𝐫𝐚 𝗯𝗼𝘅 => 𝗟𝗼̣𝗰 𝗻𝗵𝗼́𝗺 𝗱𝘂̛𝗼̛́𝗶 𝟰 𝘁𝗵𝗮̀𝗻𝗵 𝘃𝗶𝗲̂𝗻\n----------------\n[💌] => 𝐤𝐢𝐞𝐦𝐭𝐫𝐚 𝐭𝐭𝐚𝐥𝐥 => 𝐤𝐢𝐞𝐦𝐭𝐫𝐚 𝘁𝗮̂́𝘁 𝗰𝗮̉ 𝘁𝗶̉ 𝗹𝗲̣̂ 𝘁𝘂̛𝗼̛𝗻𝗴 𝘁𝗮́𝗰 𝗰𝗮́𝗰 𝘁𝗵𝗮̀𝗻𝗵 𝘃𝗶𝗲̂𝗻 𝘁𝗿𝗼𝗻𝗴 𝗯𝗼𝘅\n----------------\n[💌] => 𝐤𝐢𝐞𝐦𝐭𝐫𝐚 𝗰𝗼𝘃𝗶𝗱 => 𝗫𝗲𝗺 𝘁𝗵𝗼̂𝗻𝗴 𝘁𝗶𝗻 𝗰𝗼𝘃𝗶𝗱\n----------------\n[💌] => 𝐤𝐢𝐞𝐦𝐭𝐫𝐚 𝗺𝗮𝘆𝗺𝗮𝗻 => 𝗫𝗲𝗺 𝗧𝗶̉ 𝗹𝗲̣̂ % 𝗺𝗮𝘆 𝗺𝗮̆́𝗻 𝗰𝘂̉𝗮 𝗯𝗮̣𝗻 ?\n----------------\n[💌] => 𝐤𝐢𝐞𝐦𝐭𝐫𝐚 𝗰𝗼𝗻𝘆 => 𝗫𝗲𝗺 𝘁𝗶̉ 𝗹𝗲̣̂ % 𝗰𝗼́ 𝗻𝗴𝘂̛𝗼̛̀𝗶 𝘆𝗲̂𝘂\n----------------\n[💌] => 𝐤𝐢𝐞𝐦𝐭𝐫𝐚 𝗻𝘂𝗱𝗲 => 𝐤𝐢𝐞𝐦𝐭𝐫𝐚 𝗻𝗵𝘂̛̃𝗻𝗴 𝗮̉𝗻𝗵 𝗴𝗼̛̣𝗶 𝗰𝗮̉𝗺\n----------------\n        === 「${timeNow}」 ===`, event.threadID, event.messageID);
    var arr = [];
    ...
    const find = data.adminIDs.find(el => el.id == event.senderID && api.getCurrentUserID());
    if (!find) return api.sendMessage(` 𝐁𝐚̣𝐧 𝐯𝐚̀ 𝐛𝐨𝐭 𝐜𝐚̂̀𝐧 𝐥𝐚̀ 𝐪𝐮𝐚̉𝐧 𝐭𝐫𝐢̣ 𝐯𝐢𝐞̂𝐧 !`,event.threadID);
    if (!args[1]) return api.sendMessage(`[💌] => 𝐇𝐃𝐒𝐃: 𝐤𝐢𝐞𝐦𝐭𝐫𝐚 𝐝𝐞𝐥 => 𝐬𝐨̂́ 𝐭𝐢𝐧 𝐧𝐡𝐚̆́𝐧 𝐜𝐚̂̀𝐧 𝐥𝐨̣𝐜`,event.threadID);
      let storage = [];
...
const res = await axios.get(`https://api-dien.lam86755.repl.co/checknude?key=TyRTWWdguv&link=${encodeURIComponent(linkanh)}`);    
var img = res.data.NSFW_Prob;
    ...
    if (args[1] == "all") {
      ...
      msg = " 𝐂𝐡𝐞𝐜𝐤 𝐥𝐮̛𝐨̛̣𝐭 𝐝𝐮̀𝐧𝐠 \n";
      let countsl = 0
      for (let e of sl) {
        msg += `\n${countsl += 1}. ${e.name} - ${e.sl} 𝐥𝐮̛𝐨̛̣𝐭`
      }
      msg += `\n=> 𝐓𝐡𝐨̛̀𝐢 𝐠𝐢𝐚𝐧: 「${timeNow}」`;
      require("fs").writeFileSync(__dirname + '/../../includes/handle/usages.json', JSON.stringify(usages, null, 4));
      return api.sendMessage(msg, threadID);
    }
    api.sendMessage(`𝐁𝐚̣𝐧 𝐜𝐨̀𝐧 ${usages[senderID].usages} 𝐥𝐮̛𝐨̛̣𝐭 𝐝𝐮̀𝐧𝐠 𝐁𝐨𝐭`, threadID, messageID);	
    }
