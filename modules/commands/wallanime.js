...
module.exports.handleReply = async function({ api, event, args, handleReply, client, __GLOBAL, Threads, Users, Currencies }) {
  ...
  console.log(lengthchar.length)
    ...
    if(handleReply.step == 1){
      ...
      return api.sendMessage(`𝐁𝐚̣𝐧 đ𝐚̃ 𝐜𝐡𝐨̣𝐧 𝐜𝐡𝐚𝐫 𝐦𝐚𝐧𝐠 𝐬𝐨̂́ 𝐭𝐡𝐮̛́ 𝐭𝐮̛̣ 𝐥𝐚̀ ${event.body}, 𝐫𝐞𝐩𝐥𝐲 𝐭𝐢𝐧 𝐧𝐡𝐚̆́𝐧 𝐧𝐚̀𝐲 đ𝐞̂̉ 𝐧𝐡𝐚̣̂𝐩 𝐭𝐞̂𝐧 𝐜𝐮̉𝐚 𝐛𝐚̣𝐧`, event.threadID, (err, info) => {
    return global.client.handleReply.push({
      step: 2,
      name: this.config.name,
      chartid: event.body,
      ...
      api.unsendMessage(handleReply.messageID);
      return api.sendMessage(`𝐁𝐚̣𝐧 đ𝐚̃ 𝐜𝐡𝐨̣𝐧 𝐭𝐞̂𝐧 𝐜𝐮̉𝐚 𝐦𝐢̀𝐧𝐡 𝐥𝐚̀ ${event.body}, 𝐫𝐞𝐩𝐥𝐲 𝐭𝐢𝐧 𝐧𝐡𝐚̆́𝐧 𝐧𝐚̀𝐲 đ𝐞̂̉ 𝐧𝐡𝐚̣̂𝐩 𝐦𝐚̀𝐮 𝐛𝐚̣𝐧 𝐦𝐮𝐨̂́𝐧`, event.threadID, (err, info) => {
    return global.client.handleReply.push({
      step: 3,
      name: this.config.name,
