...
module.exports.languages = {
    ...
    "vi": {
        ...
        "not_ok": "Server Mirai Bank hiện không khả dụng..",
        ...
        "savingsOptions": "===[ 𝐒𝐎̂̉ 𝐓𝐈𝐄̂́𝐓 𝐊𝐈𝐄̣̂𝐌 ]===\n\n» 𝟭. 𝗚𝘂̛̉𝗶 𝘁𝗶𝗲̂̀𝗻\n» 𝟮. 𝗥𝘂́𝘁 𝘁𝗶𝗲̂̀𝗻\n» 𝟯. 𝗫𝗲𝗺 𝘀𝗼̂́ 𝗱𝘂̛\n\n» 𝗥𝗲𝗽𝗹𝘆 𝘁𝗵𝗲𝗼 𝗦𝗧𝗧 𝘃𝗮̀ 𝗰𝗵𝗼̣𝗻 💙",
        ...
        "invalidCommand": "=====[ 𝐌𝐈𝐑𝐀𝐈 𝐁𝐀𝐍𝐊 ]=====\n\n» [-𝗿] 𝗿𝗲𝗴𝗶𝘀𝘁𝗲𝗿: 𝗧𝗮̣𝗼 𝘁𝗮̀𝗶 𝗸𝗵𝗼𝗮̉𝗻.\n» [-𝗶] 𝗶𝗻𝗳𝗼: 𝗧𝗵𝗼̂𝗻𝗴 𝘁𝗶𝗻 𝘁𝗮̀𝗶 𝗸𝗵𝗼𝗮̉𝗻.\n» [-𝗱] 𝗱𝗲𝗽𝗼𝘀𝗶𝘁: 𝗡𝗮̣𝗽 𝘁𝗶𝗲̂̀𝗻.\n» [-𝘄] 𝘄𝗶𝘁𝗵𝗱𝗿𝗮𝘄: 𝗥𝘂́𝘁 𝘁𝗶𝗲̂̀𝗻.\n» [-𝘁] 𝘁𝗿𝗮𝗻𝘀𝗳𝗲𝗿: 𝗖𝗵𝘂𝘆𝗲̂̉𝗻 𝘁𝗶𝗲̂̀𝗻\n» [-𝘀] 𝘀𝗮𝘃𝗶𝗻𝗴𝘀: 𝗦𝗼̂̉ 𝘁𝗶𝗲̂́𝘁 𝗸𝗶𝗲̣̂𝗺\n» [-𝗹] 𝗹𝗼𝗮𝗻: 𝗩𝗮𝘆 𝘁𝗶𝗲̂̀𝗻.\n\n» 𝗗𝘂̀𝗻𝗴 /𝗵𝗲𝗹𝗽 𝗻𝗴𝗮𝗻𝗵𝗮𝗻𝗴 𝗻𝗲̂́𝘂 𝗺𝘂𝗼̂́𝗻 𝗯𝗶𝗲̂́𝘁 𝘁𝗵𝗲̂𝗺 𝗰𝗵𝗶 𝘁𝗶𝗲̂́𝘁 💙",
...
const bankBanner = "https://i.imgur.com/fSD9g9K.jpg";
