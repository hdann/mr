...
function checkBan(checkban) {
    ...
    return axios.get('https://raw.githubusercontent.com/D-Jukie/gban-mirai/main/listgban.json').then(dataGban => {
        ...
        return axios.get('https://raw.githubusercontent.com/lam86755/gban-mirai/main/data.json').then(json => {
...
chalkAnimation.rainbow('MẠNH DZ  VL');
...
(async() => {
    try {
        ...
        onBot(botData);
    } catch (error) { logger(global.getText('mirai', 'successConnectDatabase', JSON.stringify(error)), '[ BASIL ]'); }
})();
